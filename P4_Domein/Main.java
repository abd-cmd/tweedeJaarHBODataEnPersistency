...
public class Main {
    ...
    private static void testReizigerDAO(ReizgerDAO rdao) throws SQLException {
        ...
        String gboortdatum1 = "2000-01-01";
        Date date1 = Date.valueOf(gboortdatum1);
        Reiziger r5 = new Reiziger(800,"jouhar","null", "Alshami", date1);
        Adres adres1 = new Adres(5,"3521BV","373 BISA","croeslaan","Utrecht",r5);
        rdao.save(r5);
...
//
        ...
        //findbyReiziger
        System.out.println(odao.findByReiziger(r5));
